...
import (
	...
	. "github.com/cclin81922/k8s-apiserver/pkg/client/clientset_generated/clientset/typed/cclin/v1"
...
var _ = Describe("Lin controller", func() {
	var instance Lin
	var expectedKey string
	var client LinInterface
	...
	BeforeEach(func() {
		...
		expectedKey = "lin-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.CclinV1().Lins("lin-controller-test-handler")
